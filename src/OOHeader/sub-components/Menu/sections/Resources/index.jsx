...
const Resources = ({ t, locale, baseUrl, getBaseUrl, theme, highlight }) => {
  const blogHrefLang = `${
    baseUrl ? baseUrl : "https://www.onlyoffice.com"
  }/blog${
    { en: "", ru: "", zh: "/zh-hans", pt: "/pt-br", nl: "" }[locale] ??
    `/${locale}`
  }`;
  const helpcenterHrefLang = `https://helpcenter.onlyoffice.com${
    ["de", "fr", "es", "ru", "it"].includes(locale) ? `/${locale}` : ""
  }`;
      ...
      <div className="oo-header-menu-d-flex oo-header-menu-mob-flex-column oo-header-menu-mob-height-without-header">
        ...
        <div className="oo-header-menu-item">
          ...
          <MenuLink
            ...
            className="oo-header-menu-mb-12 oo-header-menu-mob-mb-8"
            href={`${helpcenterHrefLang}/guides/become-translator.aspx`}
          ...
          <MenuLink
            ...
            className="oo-header-menu-mb-12 oo-header-menu-mob-mb-8"
            href={`${helpcenterHrefLang}/index.aspx`}
            target="_blank"
            icon="help-center"
            active={highlight?.linkId}
          >
